vim.api.nvim_set_keymap('n', '5', ':source%<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '7', '/', {noremap = true})
...
vim.api.nvim_set_keymap("n", "hh", ":vsplit<CR>", {silent = true})
vim.api.nvim_set_keymap("n", "vv", ":split<CR>", {silent = true})
